                ...
                <nav id="navbar" class="navbar">
                    <ul>
                        ...
                        <li class="dropdown"><a href="#" <?php echoActiveClassIfRequestMatches("about.php"); ?>><span>About Us</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                            <ul>
                                <li><a href="about.php" <?php echoActiveClassIfRequestMatches("about.php"); ?>>Who We Are</a></li>              
                                <li><a href="managementTeam.php" <?php echoActiveClassIfRequestMatches("managementTeam.php"); ?>>Our Team</a></li>

                            </ul>
                        </li>
                        <li><a href="projects.php" <?php echoActiveClassIfRequestMatches("projects.php"); ?>>Project</a></li>
                        <li><a href="careers.php" <?php echoActiveClassIfRequestMatches("careers.php"); ?>>Careers</a></li>


                        <li><a href="contact.php" <?php echoActiveClassIfRequestMatches("contact.php"); ?>>Contact Us </a></li>
                    </ul>
                </nav><!-- .navbar -->
